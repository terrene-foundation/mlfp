...
"""
# ════════════════════════════════════════════════════════════════════════
# MLFP03 — Exercise 8: Production Deployment with Nexus
# ════════════════════════════════════════════════════════════════════════
...
async def setup_ml_stack():
    ...
    # TODO: Create ConnectionManager("sqlite:///mlfp03_nexus_demo.db"),
    #   initialize it, then instantiate ModelRegistry(conn).
    conn = ____  # Hint: ConnectionManager("sqlite:///mlfp03_nexus_demo.db")
