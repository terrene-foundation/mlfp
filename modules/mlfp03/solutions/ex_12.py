...
"""
# ════════════════════════════════════════════════════════════════════════
# MLFP03 — Exercise 4: RAG Systems
# ════════════════════════════════════════════════════════════════════════
# OBJECTIVE: Build a RAGResearchAgent over Kailash SDK documentation and
#   Singapore regulatory docs. Load real documents from the mlfp03 dataset,
#   evaluate retrieval quality, and compare dense vs hybrid retrieval.
#
# TASKS:
#   1. Load real document corpus from MLFPDataLoader (SDK docs + regulatory)
...
# Simulated document corpus (in production, load from mlfp03/ data)
sdk_docs = [
    {
