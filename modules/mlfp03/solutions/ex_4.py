...
heatmap_data = np.zeros((len(lr_sweep), len(depths_sweep)))
...
consensus_top10 = xgb_top10 & lgb_top10 & cb_top10
...
fig_fi = viz.feature_importance(best_model[1]["model"], feature_names, top_n=15)
