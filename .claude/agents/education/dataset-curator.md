...
- **Backbone**: `sg_credit_scoring.parquet` (ascent03) reused in M2, M4, M5, M6 for training→deploy→monitor→govern
- **Familiar data**: `hdb_resale.parquet` (ascent01) reused in M2 for feature engineering
- **Agent data**: `ecommerce_customers.parquet` (ascent04) reused in M5 for agent exercises
