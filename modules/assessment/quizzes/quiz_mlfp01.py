    ...
    "questions": [
        ...
        # ── Additional questions covering lessons 1–8 breadth ─────────────
        {
            ...
            "options": [
                ...
                "B) Hardcoded paths break on any other machine — use MLFPDataLoader: from shared import MLFPDataLoader; loader = MLFPDataLoader(); df = loader.load('mlfp01', 'sg_weather.csv')",
                "C) The file extension must be .parquet; CSVs are not supported",
                "D) import polars must come after from shared import MLFPDataLoader",
            ],
            "answer": "B",
            "explanation": (
                "MLFPDataLoader abstracts the file location — it resolves paths correctly on any machine, "
            ...
            "learning_outcome": "Use MLFPDataLoader for portable data loading across all exercise formats",
        },
        {
            "id": "1.4.3",
            "lesson": "1.4",
